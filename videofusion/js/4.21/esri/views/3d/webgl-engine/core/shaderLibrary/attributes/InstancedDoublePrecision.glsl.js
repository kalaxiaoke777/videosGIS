...
//>>built
define(["exports","../../../../../../chunks/vec3f64","../util/DoublePrecision.glsl","../../shaderModules/interfaces","../../../lib/doublePrecisionUtils"],function(f,g,l,c,m){function e(a,b){b.instanced&&b.instancedDoublePrecision&&(a.attributes.add("modelOriginHi","vec3"),a.attributes.add("modelOriginLo","vec3"),a.attributes.add("model","mat3"),a.attributes.add("modelNormal","mat3"));b.instancedDoublePrecision&&(a.vertex.include(l.DoublePrecision,b),a.vertex.uniforms.add("viewOriginHi","vec3"),a.vertex.uniforms.add("viewOriginLo",
"vec3"));const d=[c.glsl`
    vec3 calculateVPos() {
